...
|------|--------------|------|
| build-measurement-plan | data-chief | `tasks/instrumentation/build-measurement-plan.md` |
| implement-event-tracking | avinash-kaushik | `tasks/instrumentation/implement-event-tracking.md` |
