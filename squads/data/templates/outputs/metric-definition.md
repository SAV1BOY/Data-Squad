...
|------|--------------|------|
| define-north-star-metric | data-chief | `tasks/definition/define-north-star-metric.md` |
| define-metric-officially | data-chief | `tasks/definition/define-metric-officially.md` |
