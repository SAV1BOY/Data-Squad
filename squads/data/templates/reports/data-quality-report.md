...
| Task | Primary Agent | Path |
|------|--------------|------|
| data-quality-review | data-chief | `tasks/review/data-quality-review.md` |
| data-pipeline-health-check | avinash-kaushik | `tasks/operations/data-pipeline-health-check.md` |
| privacy-impact-assessment | data-chief | `tasks/operations/privacy-impact-assessment.md` |
